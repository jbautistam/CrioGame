...
namespace Bau.Libraries.ArkanoidGame.Logic.Model.Entities.Movements
{
	/// <summary>
	...
	public class MovementVelocity : Bau.Libraries.CrioGame.GameEngine.Scenes.Components.Physics.Movements.MovementSimple
	{
		...
		/// </summary>
		public override bool IsDisabled(IGameContext objContext, IView objView, float fltNextX, float fltNextY, bool blnBorrarEsteParametroTesting)
