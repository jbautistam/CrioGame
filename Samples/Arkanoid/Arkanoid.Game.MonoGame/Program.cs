...
namespace Bau.Libraries.ArkanoidGame.MonoGame
{
	...
	{	
		...
		[STAThread]
		static void Main()
		{	using (CrioEngine objEngine = new CrioEngine(new CrioGame.MonogameImpl.MonogameController()))
				{ // Inicializa el motor de juego
					...
					// Crea la escena
						objEngine.GameEngine.SceneController.SetScene(new Logic.Model.Scenes.MainMenuScene(new Repository.LevelsRepository()));
					// Ejecuta el motor
						objEngine.Start();
				}
		}
