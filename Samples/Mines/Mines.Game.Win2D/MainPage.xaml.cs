	...
	{ 
		...
		{	SpriteSheetContent objSpriteSheet;
				...
				// Animación de la explosión
					...
					objContentController.AddContent(objSpriteSheet.Key, objSpriteSheet);
				// Añade una fuente
					objContentController.AddFont("Font", new Libraries.CrioGame.Common.Models.Contents.Graphics.FontContent("Font", "Fonts\\ScoreFont")
																											{ Family = "Arial",
																												Size = 24
																											}
																			);
				// Añade los sonidos
					objContentController.AddSound("GameSong", "Assets\\Sounds\\gameMusic.mp3", 
																				Libraries.CrioGame.Common.Models.Contents.Sounds.SoundContent.SoundType.Song);
					objContentController.AddSound(Libraries.Mines.Logic.Configuration.LaserSound, 
																				"Assets\\Sounds\\laserFire.wav", Libraries.CrioGame.Common.Models.Contents.Sounds.SoundContent.SoundType.Effect);
					objContentController.AddSound(Libraries.Mines.Logic.Configuration.ExplosionSound, 
