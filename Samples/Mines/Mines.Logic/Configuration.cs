...
namespace Bau.Libraries.Mines.Logic
{
	/// <summary>
	...
	{
		/// <summary>
		///		Grupos de objetos del juego
		/// </summary>
		[Flags]
		public enum GroupGameObjects
			{ 
				/// <summary>Objetos de tipo jugador</summary>
				Player = 1,
				/// <summary>Objetos de tipo enemigo</summary>
				Enemy = 2,
				/// <summary>Otros tipos de objetos</summary>
				Other = 4
			}
