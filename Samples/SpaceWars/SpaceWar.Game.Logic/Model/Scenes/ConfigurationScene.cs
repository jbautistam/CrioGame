...
namespace Bau.Libraries.SpaceWar.Game.Logic.Model.Scenes
{
	...
	/// </summary>
	internal class ConfigurationScene: Bau.Libraries.CrioGame.GameEngine.Scenes.AbstractSceneModel
	{
		/// <summary>
		...
		{ // Crea los checkbox
			...
			// Añade el fondo
				Map.AddGameEntity(ViewDefault, Layer.Background.ToString(), new BackgroundEntity(ViewDefault, "Stars1Background", 0, 0, 0));
			// Añade los botones
				Map.AddGameEntity(ViewDefault, Layer.UserInterface.ToString(), SongCheckBox);
				Map.AddGameEntity(ViewDefault, Layer.UserInterface.ToString(), EffectsCheckBox);
				Map.AddGameEntity(ViewDefault, Layer.UserInterface.ToString(), AcceptButton);
				Map.AddGameEntity(ViewDefault, Layer.UserInterface.ToString(), CancelButton);
		}
